export const config = {
     ...
     */
     /*  onPrepare: function () {
         // Function to stop the Appium server
         function stopAppiumServer() {
            exec('appium --shutdown', (error, stdout, stderr) => {
                if (error) {
                ...
                console.log(`Appium server stopped successfully: ${stdout}`);
            });
        }

        // Call the function to stop the Appium server
        stopAppiumServer();
